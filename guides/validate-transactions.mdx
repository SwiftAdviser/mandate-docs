...
Common block reasons include `per_tx_limit_exceeded`, `daily_quota_exceeded`, `address_not_allowed`, `action_blocked`, `reason_blocked`, and `outside_schedule`. See [Block Reasons](/reference/block-reasons) for the full list of 14 codes.
