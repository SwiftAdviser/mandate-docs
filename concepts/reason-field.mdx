...
The reason field is a required string in every validation call that explains why the agent wants to transact. It is a free-text description (max 1,000 characters) of the agent's intent, written at the moment the agent decides to transact. Mandate uses it for three purposes: audit trails, prompt injection detection, and policy intelligence.
